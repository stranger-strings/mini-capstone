Supplier.create(
  ...
  phone_number: "243222342"
)
Supplier.create(
  name: "Think Geek",
  email: "thinkgeek@email.com",
  phone_number: "5432534"
)
...
Product.create(
  ...
  name: "Lightsaber",
  price: "270.0",
  description: "Part laser,
  part samuri sword,
  all awesome. The lightsaber is an elogant weapon for a more civilized age,
  not nearly as clumsy as a blaster"
)
Image.create(
...
Image.create(
  url: "http://www.thinkgeek.com/images/products/zoom/imkj_12th_doc_sonic_screw_remote.jpg",
  product_id: 6
)
...
Image.create(
  url: "https://staticdelivery.nexusmods.com/mods/1151/images/12353-0-1461721913.png",
  product_id: 7
)
