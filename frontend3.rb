...
class Frontend
  def initialize
    ...
    @menu_options = {
      "Show all products" => -> do show_all_products end,
      "  Show all products that match search terms" => -> do show_all_products_search end,
      "  Show all products sorted by price" => -> do show_all_products_sorted_by_price end,
      "Create a product" => -> do create_product end,
      "Show one product" => -> do show_one_product end,
      "Update a product" => -> do update_product end,
      "Delete a product" => -> do delete_product end,
      "Order a product" => -> do order_product end,
      "View all orders" => -> do show_all_orders end,
      "Sign up (create a user)" => -> do signup end,
